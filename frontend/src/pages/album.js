...
export default function Album() {
  ...
  const restaurants = [restaurants0, restaurants1, restaurants2, restaurants3]
  ...
  const handleClick5 = (event) => {
    ...
    if (card == 0){
      ...
      setCardNum([card_num[0]+1, card_num[1],card_num[2]+1,card_num[3]])
    }
    else if (card == 3){
      ...
      <main>
        ...
        > 
          ...
          <Card sx={{ maxWidth: 1200 }}>
              ...
              <CardActions>
                <Button id='0' type="submit" size="small" onClick={handleClick4}>식당 링크 열기</Button>
                <Button id='0' type="submit" size="small" onClick={handleClick5}>다른 결과 보기</Button>
              </CardActions>
            </Card>
