...
def main():
    ...
    # SQL에서 json 데이터 받아오는 부분
    '''
    user_id : encoding 된 현재 사용자 ID
    user_seq : [(해당 user의 식당 리뷰 시퀀셜 데이터)]
    _x : x좌표
    _y : y좌표
    '''
    user_id = 1
    user_seq = [3, 5, 2, 1, 10, 14]
    _x = 30
    _y = 20
    ...
    model.load_state_dict(torch.load('../data/Finetune_full-ML.pt'))
